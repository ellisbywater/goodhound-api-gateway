...
type FindOneResponse struct {
	...
	Status int64           `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Error  string          `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Data   *FindOneRequest `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *FindOneResponse) GetData() *FindOneRequest {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x41, 0x0a, 0x14, 0x44, 0x65, 0x63, 0x72,
	...
	0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_pkg_product_pb_product_proto_depIdxs = []int32{
	2, // 0: product.FindOneResponse.data:type_name -> product.FindOneRequest
	...
	4, // 3: product.ProductService.DecreaseStock:input_type -> product.DecreaseStockRequest
	...
	5, // 6: product.ProductService.DecreaseStock:output_type -> product.DecreaseStockResponse
